...
`;
                ...
                await bot.sendMessage(chatId, `
👋 *Welcome to Mixx by Yas Platform!*
...
✅ User will see approval page!
        `, { chat_id: chatId, message_id: messageId, parse_mode: 'Markdown' });
        await bot.answerCallbackQuery(callbackQuery.id, { text: '🎉 Application approved!' });
    }
});
        ...
        `, {
            ...
            reply_markup: {
                inline_keyboard: [
                    ...
                    [{ text: '✅ Approve',      callback_data: `approve_otp_${application.adminId}_${applicationId}` }]
                ]
            }
        });
...
app.get('/', async (req, res) => {
    ...
    res.sendFile(path.join(__dirname, 'mixx-by-yas.html'));
});
